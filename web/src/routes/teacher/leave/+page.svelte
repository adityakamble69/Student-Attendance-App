<!-- routes/teacher/leave/+page.svelte — Phase 7: Teacher Leave Requests Review -->
<script lang="ts">
...
<div class="screen">
  ...
  <h1 class="screen-title">Student Leave Requests</h1>
  <p class="screen-subtitle">Review, approve, or reject student absence applications.</p>
  ...
  {:else if leaves.length === 0}
    <div class="empty-state">
      ...
      <p class="empty-desc">All student leave requests have been addressed.</p>
    </div>
  {:else}
